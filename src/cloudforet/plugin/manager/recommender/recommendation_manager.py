...
from cloudforet.plugin.config.global_conf import ASSET_URL, RECOMMENDATION_TYPE_DOCS_URL, UNAVAILABLE_RECOMMENDER_IDS
...
class RecommendationManager(ResourceManager):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.metadata_path = (
            "plugin/metadata/recommender/recommendation/all_recommendations.yaml"
        )
        ...
        for product in prd_serv_recs:
            for product_service in prd_serv_recs[product]:
                ...
                data = {
                    ...
                    "overallPriorities": overall_values["priorities"],
...
recommendations?project={self.project_id}",
    ...
    @classmethod
    def _add_category_specific_data(cls, data: dict, rec: dict) -> dict:
        return data
    ...
    def _get_overall_values(self, recs: list) -> dict:
        locations, last_refresh_times, priorities, states, categories = set(), set(), {}, set(), set()
        for rec in recs:
        ...
        for asset in assets:
            ...
            if cloud_service_group not in parents_and_locations_map:
                ...
                if (
                    ...
                    if (
                            locations
                            not in parents_and_locations_map[cloud_service_group][cloud_service_type]
                    ):
                        parents_and_locations_map[cloud_service_group][
                            cloud_service_type
                        ].append(locations)
